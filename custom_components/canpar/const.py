"""Constants for the Canpar parcel tracker integration."""
...
# normalize_parcel() in parcels.py — never omit the key, just leave it
...
CAPABILITIES = frozenset({"delivery_window", "pickup_point", "history"})
...
# Canpar's public endpoint is a JSON POST. A missing parcel is HTTP 200 with
# ``error: null`` and an empty ``result`` array.
TRACKING_API_URL = "https://canship.canpar.com/api/CanparAddons/trackByBarcodeV2"
TRACKING_URL = "https://www.canpar.com/en/track/"
